...
class HolidaysController extends AppController {
    ...
    public function index() {
        ...
        $totalHolidays = $this->Holiday->find('count');
        $this->set(compact('totalHolidays'));
    }
    ...
    public function edit($id = null) {
        ...
        if ($this->request->is(array('post', 'put'))) {
            if ($this->Holiday->save($this->request->data)) {
                $this->Flash->success(__('The holiday has been updated.'));
                return $this->redirect(array('action' => 'index'));
            } else {
                $this->Flash->error(__('The holiday could not be updated. Please, try again.'));
            }
        } else {
