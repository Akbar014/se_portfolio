<div class="contacts index">
        <div class="page_title">
            <br>
            <div class="pagenation">&nbsp;<?php echo $this->Html->link('Home', array('controller' => 'users', 'action' => 'dashboard'), array('escape' => false)); ?> <i>/</i> Contact List</div>
            <br>
        </div>
    <div class="row">
        <div class="col-lg-12">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('replay'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($contact['Contact']['name']); ?>&nbsp;</td>
                <td><p><?php echo h($contact['Contact']['phone']); ?></p><p><?php echo h($contact['Contact']['email']); ?></p>&nbsp;</td>
		<td><?php echo h($contact['Contact']['subject']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['message']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['replay']); ?>&nbsp;</td>
		<td><?php echo h($contact['Contact']['status']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__("<i style='color:green' class='fa fa-eye'></i>"), array('action' => 'view', $contact['Contact']['id']), array('escape' => false, 'title' => 'View')); ?>
			<?php echo $this->Html->link(__("<i style='color:black' class='fa fa-edit'></i>"), array('action' => 'edit', $contact['Contact']['id']), array('escape' => false, 'title' => 'Edit')); ?>
			<?php echo $this->Form->postLink(__("<i style='color:red' class='fa fa-trash-o'></i>"), array('action' => 'delete', $contact['Contact']['id']), array('escape' => false, 'title' => 'Delete', 'confirm' => __('Are you sure you want to delete # %s?', $contact['Contact']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
