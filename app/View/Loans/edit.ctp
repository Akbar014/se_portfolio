        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <fieldset>
                    ...
                    echo $this->Form->input('loan_date',  array('type' => 'text'));
            ...
            <div class="actions">
                ...
                <ul>
                    ...
                    <li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Loan.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Loan.id')))); ?></li>
