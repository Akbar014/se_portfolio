<div class="menus index">
        <div class="page_title">
            <br>
            <div class="pagenation">&nbsp;<?php echo $this->Html->link('Home', array('controller' => 'users', 'action' => 'dashboard'), array('escape' => false)); ?> <i>/</i> Menu List</div>
             <br>
        </div>
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <tbody>
                        <?php foreach ($menus as $menu): ?>
                            <tr>
                                ...
                                <td><?php echo $types[$menu['Menu']['type']]; ?>&nbsp;</td>
                                <td>
                                    <?php echo $this->Html->link($menu['Page']['title'], array('controller' => 'pages', 'action' => 'view', $menu['Page']['id'])); ?>
                                </td>
                                <td><?php echo ($menu['Menu']['parent_id'] > 0) ? $parents[$menu['Menu']['parent_id']] : 'NIL'; ?>&nbsp;</td>
                                ...
                                <td><?php echo $status[$menu['Menu']['status']]; ?>&nbsp;</td>
                                
                                <td class="actions">
                                    <?php echo $this->Html->link(__("<i style='color:green' class='fa fa-eye'></i>"), array('action' => 'view', $menu['Menu']['id']), array('escape' => false, 'title' => 'View')); ?>
                                    <?php echo $this->Html->link(__("<i style='color:black' class='fa fa-edit'></i>"), array('action' => 'edit', $menu['Menu']['id']), array('escape' => false, 'title' => 'Edit')); ?>
                                    <?php echo $this->Form->postLink(__("<i style='color:red' class='fa fa-trash-o'></i>"), array('action' => 'delete', $menu['Menu']['id']), array('confirm' => __('Are you sure you want to delete?'), 'escape' => false));?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
