...
<?php echo $this->Form->create('Lender'); ?>
	<fieldset>
		<legend><?php echo __('Edit Lender'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Lender.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Lender.id')))); ?></li>
