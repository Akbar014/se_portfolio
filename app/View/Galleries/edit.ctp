<div class="galleries form">
    <div class="page_title">
        <br>
        <div class="pagenation">&nbsp;<?php echo $this->Html->link('Home', array('controller' => 'users', 'action' => 'dashboard'), array('escape' => false)); ?> <i>/</i> Save Gallery</div>
        <br>
    </div>
        ...
        <div class="col-md-12 divcard">
            ...
            <div class="row">
                <div class="col-lg-6 col-xs-offset-3">
                    ...
                    echo $this->Form->input('image', array('label' => 'Gallery Image', 'type' => 'file', 'class' => 'pageimage2'));
