<div class="testimonials view">
    <div class="page_title">
        <br>
        <div class="pagenation">&nbsp;<?php echo $this->Html->link('Home', array('controller' => 'users', 'action' => 'dashboard'), array('escape' => false)); ?> <i>/</i> Testimonial Details</div>
        <br>
    </div>
	...
	<tr>
		<td><?php echo __('Creator'); ?></td>
		<td>
			<?php echo h($testimonial['Testimonial']['creator']); ?>
			&nbsp;
		</td>
	</tr>
	<tr>
