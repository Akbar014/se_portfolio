...
<?php echo $this->Form->create('Subscribe'); ?>
	<fieldset>
		<legend><?php echo __('Edit Subscribe'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Subscribe.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Subscribe.id')))); ?></li>
